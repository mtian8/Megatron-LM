...
from megatron.core.models.llama import Llama3Model
...
def model_provider(pre_process=True, post_process=True) -> Union[Llama3Model, megatron.legacy.model.GPTModel]:
    """Builds the model.
